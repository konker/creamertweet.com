...
class RequestHandler(object):
    ...
    #AMEND by konker@gmail.com
    #(allow optional message to be passed on through the chain)
    def send_error(self, status_code=500, message=''):
        ...
        message = self.get_error_html(status_code, message)
        self.finish(message)
    ...
    def _handle_request_exception(self, e):
        if isinstance(e, HTTPError):
            ...
            if e.status_code not in httplib.responses:
                ...
                self.send_error(e.status_code, e.log_message)
        else:
